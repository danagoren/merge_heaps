public class DisjointUnsortedHeap {
    private List heap;
    ...
    public DisjointUnsortedHeap union(DisjointUnsortedHeap otherHeap) {
        ...
        if (secondHead == null) {
            return DisjointUnsortedHeap.this;
        }//for every heap A: emptyHeap.union(A)=A
        DisjointUnsortedHeap newHeap = new DisjointUnsortedHeap(); //creating a new heap
        newHeap.makeHeap();
